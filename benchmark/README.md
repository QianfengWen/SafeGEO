...
| `full` | All 22 packages across all 3 sampled targets plus controls. |
...
600 instances (120 vertical-balanced base cases, one sampled target per case, three high-effect
realistic packages, and two controls). Attack selection makes it a biased
